...
// full grip
module
rod_bearing_grip(d_rod=3,angle_rod=0,d_bearing=8,h_bearing=7,clr_d_bearing=0.4,clr_h_bearing=0.6,clr_d_rod=0.4,over=1.5,fn=32)
{
  d1_kuglager=d_bearing;
  h_kuglager=h_bearing;
  spacer_outer_clearance=clr_d_bearing;
  ...
  difference()
  {
    ...
    union()
    {
      for(i=[-1:2:1])
    rotate([45*i,0,0])
      translate([0,i*d1_kuglager/2,0])
        cube([d1_kuglager,d1_kuglager,clr_h_bearing/sin(45)],center=true);
    }
